        ...
        <div className="modal-overlay">
            <div className="modal-banner">
                ...
                <div className="modal-content">
                    ...
                    <p>
                        <strong>2. Personal Information:</strong> To uase our platform for selling or listing items, you must provide your complete address and accurate personal information. This information is necessary to ensure transparency and compliance with our policies.
                    </p>
                    <p>
                        <strong>3. Brokerage Policies:</strong> By using our platform, you acknowledge and agree to the brokerage policies outlined. This includes any fees, commissions, or charges applicable for transactions conducted through our platform.
                    </p>
                    <p>
